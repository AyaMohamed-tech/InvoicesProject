				...
				<div class="row row-sm">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7">عدد الفواتير : {{ \App\Invoice::count() }}</p>
										</div>
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-danger-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">الفواتيرالغير مدفوعة</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7">
												عدد الفواتير الغير مدفوعة : {{ \App\Invoice::where('Value_Status',2)->count() }}
											</p>
										</div>
										<span class="float-right my-auto mr-auto">
											...
											{{ round( (\App\Invoice::where('Value_Status',2)->count() / \App\Invoice::count())*100) }}% 
										    @else     
											{{ \App\Invoice::count() }} = 0;
											@endif
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7">
												عدد الفواتير المدفوعة :  {{ \App\Invoice::where('Value_Status',1)->count() }}
											</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
											<span class="text-white op-7">
												...
												@if( \App\Invoice::count() != 0)     
												{{ round( (\App\Invoice::where('Value_Status',1)->count() / \App\Invoice::count())*100) }}%
												@else     
												{{ \App\Invoice::count() }} = 0;
												@endif
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7">
												عدد الفواتير المدفوعة جزئيا  :  {{ \App\Invoice::where('Value_Status',3)->count() }}
											</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7">
												...
												@if( \App\Invoice::count() != 0)     
												{{ round( (\App\Invoice::where('Value_Status',3)->count() / \App\Invoice::count())*100) }}%
												@else     
												{{ \App\Invoice::count() }} = 0;
												@endif
